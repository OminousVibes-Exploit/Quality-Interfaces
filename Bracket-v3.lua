...
local function MakeDraggable(ClickObject, Object)
    ...
    ClickObject.InputBegan:Connect(
        function(Input)
    ...
    ClickObject.InputChanged:Connect(
        function(Input)
            if
...
function Library:CreateWindow(Config, Parent)
    ...
    RunService.RenderStepped:Connect(
        function()
            if Library.Toggle then
                Screen.ToolTip.Position =
                    UDim2.new(
                    0,
                    UserInputService:GetMouseLocation().X + 10,
                    0,
    ...
    function WindowInit:CreateTab(Name)
        ...
        Tab.LeftSide.ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
            function()
        ...
        Tab.RightSide.ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
            function()
                if GetSide(true).Name == Tab.LeftSide.Name then
                    Tab.CanvasSize = UDim2.new(0, 0, 0, Tab.LeftSide.ListLayout.AbsoluteContentSize.Y + 15)
                else
        ...
        function TabInit:CreateSection(Name)
            ...
            Section.Container.ListLayout:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(
                function()
                    ...
                    if tostring(Name):gsub(" ", "") ~= "" then
                        Button.MouseEnter:Connect(
                            function()
                                ...
                                Screen.ToolTip.Size =
                                    UDim2.new(0, Screen.ToolTip.TextBounds.X + 5, 0, Screen.ToolTip.TextBounds.Y + 5)
            ...
            function SectionInit:CreateTextBox(Name, PlaceHolder, NumbersOnly, Callback)
                ...
                TextBox.Background.Input.FocusLost:Connect(
                    function()
            ...
            function SectionInit:CreateToggle(Name, Default, Callback)
                ...
                function ToggleInit:CreateKeybind(Bind, Callback)
                    ...
                    Toggle.Keybind.MouseButton1Click:Connect(
                        function()
                            Toggle.Keybind.Text = "[ ... ]"
                            WaitingForBind = true
                        end
                    ...
                    Toggle.Keybind:GetPropertyChangedSignal("TextBounds"):Connect(
                        function()
            ...
            function SectionInit:CreateSlider(Name, Min, Max, Default, Precise, Callback)
                ...
                Slider.Value.FocusLost:Connect(
                    function()
            ...
            function SectionInit:CreateColorpicker(Name, Callback)
                ...
                local function UpdateColor()
                    ...
                    Pallete.Input.InputBox.PlaceholderText =
                        "RGB: " ..
                ...
                Pallete.GradientPallete.InputBegan:Connect(
                    function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                            if ColorRender then
                ...
                Pallete.GradientPallete.InputEnded:Connect(
                    function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                            if ColorRender then
                                ColorRender:Disconnect()
                ...
                Pallete.ColorSlider.InputBegan:Connect(
                    function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                            if HueRender then
                ...
                Pallete.ColorSlider.InputEnded:Connect(
                    function(Input)
                        if Input.UserInputType == Enum.UserInputType.MouseButton1 then
                            if HueRender then
                                HueRender:Disconnect()
                ...
                Pallete.Input.InputBox.FocusLost:Connect(
                    function(Enter)
                        if Enter then
